...
export const testCases: Scenario[] = [
	{
		msg: 'print {{.}}',
		tpl: '{{.}}',
		data: 'OoO',
		...
		msg: 'lop, dot and single item scopes',
		...
		res: '<article><h1>_heading_</h1><p>_intro_</p><img src="_src_" title="_title_"/><hr/><img src="_src_" title="_title_"/></article><article><h1>_heading_</h1><p>_intro_</p><img src="_src_" title="_title_"/><hr/><img src="_src_" title="_title_"/></article><article><h1>_heading_</h1><p>_intro_</p><img src="_src_" title="_title_"/><hr/><img src="_src_" title="_title_"/></article>'
	},
	{
		msg: "articles 1",
		tpl: `{{#articles}}{{.}}\n{{/articles}}---\n{{#articles}}{{.}}\n{{/articles}}`,
		...
		msg: "uppercase helper 1",
		tpl: `-{{uppercase "blubb"}}-`,
		data: {
		},
		res: '-BLUBB-'
	}, {
		msg: "uppercase helper 2",
		tpl: `-{{uppercase prop}}-`,
		data: {
			prop: 'fluff'
		},
